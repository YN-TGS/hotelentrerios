...
3. DNS del dominio: registros A del apex a GitHub Pages (185.199.108.153, .109.153, .110.153, .111.153) y **`www` como CNAME a `lvilchesa.github.io`**. Esto fue lo que destrabó el HTTPS en Licahue (24-sep-2026). Hoy el dominio está en el hosting de SomosWeb.cl; hay que ver quién administra el DNS.
